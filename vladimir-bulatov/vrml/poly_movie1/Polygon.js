...
function init8(){
  ...
  var c = 0;      
  ci8_0[c++] = 0; ci8_0[c++] = 8; ci8_0[c++] = 11; ci8_0[c++] = 3; ci8_0[c++] = -1; 
  ci8_0[c++] = 4; ci8_0[c++] = 9; ci8_0[c++] = 8; ci8_0[c++] = 7; ci8_0[c++] = -1; 
  ci8_0[c++] = 2; ci8_0[c++] = 10; ci8_0[c++] = 9; ci8_0[c++] = 1; ci8_0[c++] = -1; 
  ci8_0[c++] = 6; ci8_0[c++] = 11; ci8_0[c++] = 10; ci8_0[c++] = 5; ci8_0[c++] = -1; 
...
function makeIFS8(){
  ...
  if(Math.abs(cosphi) < EPS){
    //case 0  - two rectangles
    ci = ci8_0;
    if(v[2].subtract(v[1]).length() > v[1].subtract(v[0]).length()){
      shift_vertices(v);
    }
    for(var i = 0; i < 4; i++){
      v[i+4] = rot1.multVec(v[i]);
    }
    v[8] = new SFVec3f(0,0,0);
    intersection3D(v[0],v[1],v[7],v[6],v[8]);
    for(var i = 0; i < 3; i++){
